...
public class JacksonCustomOwnerSerializer extends StdSerializer<Owner> {
	...
	public void serialize(Owner owner, JsonGenerator jgen, SerializerProvider provider) throws IOException {
        ...
        jgen.writeBooleanField("enabled", owner.getEnabled());

        // Convert boolen enabled owner flag, to semantic string
        // if(owner.getEnabled()){
        //     jgen.writeStringField("enabled", "ativo");
        // }else{
        //     jgen.writeStringField("enabled", "inativo");
        // }
